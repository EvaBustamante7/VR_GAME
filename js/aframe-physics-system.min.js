!(function () {
  ...
  })()(
    {
          ...
          require("./src/components/math"),
            ...
            (module.exports = {
              registerAll: function () {
                console.warn(
                  "registerAll() is deprecated. Components are automatically registered."
                );
              },
            }),
      ...
      2: [
        function (require, module, exports) {
          ...
          (CANNON.shape2mesh = function (body) {
            for (
              var obj = new THREE.Object3D(), l = 0;
              l < body.shapes.length;
              l++
            ) {
              var mesh,
                shape = body.shapes[l];
              switch (shape.type) {
                ...
                case CANNON.Shape.types.CONVEXPOLYHEDRON:
                  for (
                    var geo = new THREE.Geometry(), i = 0;
                    i < shape.vertices.length;
                    i++
                  ) {
                  ...
                  for (i = 0; i < shape.faces.length; i++)
                    for (
                      var face = shape.faces[i], a = face[0], j = 1;
                      j < face.length - 1;
                      j++
                    ) {
                      var b = face[j],
              ...
              if (
                ((mesh.receiveShadow = !0), (mesh.castShadow = !0), mesh.children)
              )
                for (i = 0; i < mesh.children.length; i++)
                  if (
                    ((mesh.children[i].castShadow = !0),
      ...
      3: [
        function (require, module, exports) {
          (THREE.AmmoDebugConstants = {
            ...
            (THREE.AmmoDebugDrawer = function (scene, world, options) {
              (this.scene = scene),
                ...
                (this.debugDrawMode =
                  ...
                  THREE.AmmoDebugConstants.DrawWireframe);
              var drawOnTop =
                  this.debugDrawMode & THREE.AmmoDebugConstants.DrawOnTop || !1,
              ...
              this.geometry.addAttribute(
                "position",
                new THREE.BufferAttribute(vertices, 3).setDynamic(!0)
              ),
                this.geometry.addAttribute(
                  "color",
                  new THREE.BufferAttribute(colors, 3).setDynamic(!0)
                ),
                (this.index = 0);
              ...
              (this.mesh = new THREE.LineSegments(this.geometry, material)),
                ...
                (this.debugDrawer.drawContactPoint =
                  this.drawContactPoint.bind(this)),
                (this.debugDrawer.reportErrorWarning =
                  this.reportErrorWarning.bind(this)),
            ...
            (THREE.AmmoDebugDrawer.prototype.drawLine = function (
              from,
              to,
              color
            ) {
            ...
            (THREE.AmmoDebugDrawer.prototype.drawContactPoint = function (
              pointOnB,
              normalOnB,
              distance,
              lifeTime,
            ...
            (THREE.AmmoDebugDrawer.prototype.reportErrorWarning = function (
              warningString
            ) {
            ...
            (THREE.AmmoDebugDrawer.prototype.draw3dText = function (
              location,
              textString
            ) {
        ...
        function (require, module, exports) {
          ...
          var ObjectCollisionMatrix = (function () {
            ...
            Mat3 = (function () {
              ...
              return (
                ...
                (_proto.scale = function (vector, target) {
                  void 0 === target && (target = new Mat3());
                  for (
                    var e = this.elements, t = target.elements, i = 0;
                    3 !== i;
                    i++
                  )
                      ...
                      for (j = i + 1; j < k; j++) {
                        ...
                        do {
                          eqns[(p = 4 - np) + 4 * j] =
                            p <= i
                              ? 0
                              : eqns[p + 4 * j] - eqns[p + 4 * i] * multiplier;
                        } while (--np);
                      }
                  } while (--n);
                  if (
                    ...
                    (target.x =
                      (eqns[3] - eqns[2] * target.z - eqns[1] * target.y) /
                      eqns[0]),
                    isNaN(target.x) ||
                      isNaN(target.y) ||
                      isNaN(target.z) ||
                ...
                (_proto.reverse = function (target) {
                      ...
                      for (j = i + 1; j < k; j++) {
                        ...
                        do {
                          eqns[(p = 6 - np) + 6 * j] =
                            p <= i
                              ? 0
                              : eqns[p + 6 * j] - eqns[p + 6 * i] * multiplier;
                        } while (--np);
                      }
                  } while (--n);
                  i = 2;
                  do {
                    ...
                    do {
                      ...
                      do {
                        eqns[(p = 6 - np) + 6 * j] =
                          eqns[p + 6 * j] - eqns[p + 6 * i] * _multiplier;
                      } while (--np);
                    } while (j--);
                  } while (--i);
                  i = 2;
                ...
                (_proto.transpose = function (target) {
                  void 0 === target && (target = new Mat3());
                  for (
                    var Mt = target.elements, M = this.elements, i = 0;
                    3 !== i;
                    i++
                  )
            ...
            Vec3 = (function () {
              ...
              return (
                (_proto.cross = function (vector, target) {
                  void 0 === target && (target = new Vec3());
                  var vx = vector.x,
                    vy = vector.y,
                    vz = vector.z,
          ...
          var EventTarget = (function () {
              ...
              return (
                (_proto.addEventListener = function (type, listener) {
                ...
                (_proto.hasEventListener = function (type, listener) {
                  ...
                  var listeners = this._listeners;
                  return !(
                    void 0 === listeners[type] ||
                    !listeners[type].includes(listener)
                  );
                }),
                (_proto.hasAnyEventListener = function (type) {
                  return (
                    void 0 !== this._listeners && void 0 !== this._listeners[type]
                  );
                }),
                ...
                (_proto.setFromVectors = function (u, v) {
                  if (u.isAntiparallelTo(v)) {
                    ...
                    (this.x = a.x),
                      ...
                      (this.w =
                        Math.sqrt(
                          Math.pow(u.length(), 2) * Math.pow(v.length(), 2)
                        ) + u.dot(v)),
                      this.normalize();
                  }
                  return this;
              ...
              function Shape(options) {
                void 0 === options && (options = {}),
                  ...
                  (this.collisionFilterGroup =
                    void 0 !== options.collisionFilterGroup
                      ? options.collisionFilterGroup
                      : 1),
                  (this.collisionFilterMask =
                    void 0 !== options.collisionFilterMask
          ...
          var Transform = (function () {
              ...
              return (
                (_proto.pointToLocal = function (worldPoint, result) {
            ...
            ConvexPolyhedron = (function (_Shape) {
              function ConvexPolyhedron(props) {
                ...
                return (
                  ((_this =
                    _Shape.call(this, { type: Shape.types.CONVEXPOLYHEDRON }) ||
              ...
              return (
                      ...
                      for (var _j = 0; _j < this.faces[i].length; _j++)
                        console.warn(
                          ".vertices[" +
                            this.faces[i][_j] +
                            "] = Vec3(" +
                            this.vertices[this.faces[i][_j]].toString() +
                            ")"
                        );
                    }
                  }
                ...
                (_proto.clipAgainstHull = function (
                  posA,
                  quatA,
                  hullB,
                  posB,
                  ...
                  for (
                    var worldVertsB1 = [], i = 0;
                    i < hullB.faces[closestFaceB].length;
                    i++
                  ) {
                ...
                (_proto.findSeparatingAxis = function (
                  hullB,
                  posA,
                  quatA,
                  posB,
                ...
                (_proto.clipFaceAgainstHull = function (
                  separatingNormal,
                  posA,
                  quatA,
                  worldVertsB1,
                  ...
                  if (!(closestFaceA < 0)) {
                    ...
                    for (var i = 0; i < this.faces.length; i++)
                      for (var j = 0; j < this.faces[i].length; j++)
                        -1 !== polyA.indexOf(this.faces[i][j]) &&
                          i !== closestFaceA &&
                          -1 === polyA.connectedFaces.indexOf(i) &&
                          polyA.connectedFaces.push(i);
                    for (
                      var numVerticesA = polyA.length, _i4 = 0;
                      _i4 < numVerticesA;
                      _i4++
                    ) {
                ...
                (_proto.clipFaceAgainstPlane = function (
                  inVertices,
                  outVertices,
                  planeNormal,
                  planeConstant
                ...
                (_proto.updateBoundingSphereRadius = function () {
                  for (
                    var max2 = 0, verts = this.vertices, i = 0;
                    i !== verts.length;
                    i++
                  ) {
          ...
          var Box = (function (_Shape) {
            function Box(halfExtents) {
              ...
              return (
                ((_this =
                  _Shape.call(this, { type: Shape.types.BOX }) ||
            ...
            return (
              (_proto.updateConvexPolyhedronRepresentation = function () {
          ...
          var worldCornerTempPos = new Vec3(),
            ...
            Body = (function (_EventTarget) {
              function Body(options) {
                var _this;
                void 0 === options && (options = {}),
                  ((_this = _EventTarget.call(this) || this).id =
                    Body.idCounter++),
                  (_this.index = -1),
                  (_this.world = null),
                  (_this.preStep = null),
                  ...
                  (_this.collisionFilterMask =
                    "number" == typeof options.collisionFilterMask
                      ? options.collisionFilterMask
                      : -1),
                  (_this.collisionResponse =
                    "boolean" != typeof options.collisionResponse ||
                ...
                return (
                  ...
                  (_this.allowSleep =
                    void 0 === options.allowSleep || options.allowSleep),
                  (_this.sleepState = 0),
                  (_this.sleepSpeedLimit =
                    void 0 !== options.sleepSpeedLimit
                      ? options.sleepSpeedLimit
                      : 0.1),
                  (_this.sleepTimeLimit =
                    void 0 !== options.sleepTimeLimit
                ...
                (_proto.applyLocalForce = function (localForce, localPoint) {
                  if (this.type === Body.DYNAMIC) {
                    var worldForce = Body_applyLocalForce_worldForce,
                      relativePointWorld =
                        Body_applyLocalForce_relativePointWorld;
          ...
          var tmpVec = new Vec3(),
              ...
              return (
                ...
                (_proto.needBroadphaseCollision = function (bodyA, bodyB) {
                  return (
                    ...
                    0 !=
                      (bodyB.collisionFilterGroup & bodyA.collisionFilterMask) &&
                    ((0 == (bodyA.type & Body.STATIC) &&
                      bodyA.sleepState !== Body.SLEEPING) ||
                      (0 == (bodyB.type & Body.STATIC) &&
                        bodyB.sleepState !== Body.SLEEPING))
                  );
                }),
                (_proto.intersectionTest = function (
                  bodyA,
                  bodyB,
                  pairs1,
                  pairs2
                  ...
                  this.useBoundingBoxes
                    ...
                    : this.doBoundingSphereBroadphase(
                        bodyA,
                        bodyB,
                        pairs1,
                        pairs2
                ...
                (_proto.doBoundingSphereBroadphase = function (
                  bodyA,
                  bodyB,
                  pairs1,
                  pairs2
                  ...
                  r.lengthSquared() < boundingRadiusSum2 &&
                    (pairs1.push(bodyA), pairs2.push(bodyB));
                }),
                (_proto.doBoundingBoxBroadphase = function (
                  bodyA,
                  bodyB,
                  pairs1,
                  pairs2
            ...
            Broadphase_makePairsUnique_temp =
              (new Vec3(), new Quaternion(), new Vec3(), { keys: [] }),
          ...
          var GridBroadphase = (function (_Broadphase) {
                    ...
                    if (binLength > 1)
                      for (var bin = bins[_i2], _xi = 0; _xi !== binLength; _xi++)
                        for (var _bi = bin[_xi], _yi = 0; _yi !== _xi; _yi++) {
                          var bj = bin[_yi];
                          this.needBroadphaseCollision(_bi, bj) &&
            ...
            NaiveBroadphase =
              ...
              (function (_Broadphase) {
                ...
                return (
                  (_proto.collisionPairs = function (world, pairs1, pairs2) {
                    for (
                      var bi, bj, bodies = world.bodies, n = bodies.length, i = 0;
                      i !== n;
                      i++
                    )
                      for (var j = 0; j !== i; j++)
            ...
            Ray = (function () {
              ...
              return (
                (_proto.intersectWorld = function (world, options) {
                  return (
                    ...
                    (this.checkCollisionResponse =
                      void 0 === options.checkCollisionResponse ||
                ...
                (_proto.intersectShape = function (shape, quat, position, body) {
                  if (
                    !(
                      ...
                      })(this.from, this.direction, position) >
                ...
                (_proto._intersectPlane = function (
                  shape,
                  quat,
                  position,
                  body,
                  ...
                  if (
                    ...
                    !(
                      planeToFrom * len.dot(worldNormal) > 0 ||
                      from.distanceTo(to) < planeToFrom
                    ))
                  ) {
                ...
                (_proto._intersectHeightfield = function (
                  shape,
                  quat,
                  position,
                  body,
                ...
                (_proto._intersectSphere = function (
                  sphere,
                  quat,
                  position,
                  body,
                ...
                (_proto._intersectConvex = function (
                  shape,
                  quat,
                  position,
                  body,
                ...
                (_proto._intersectTrimesh = function (
                  mesh,
                  quat,
                  position,
                  body,
                ...
                (_proto.reportIntersection = function (
                  normal,
                  hitPointWorld,
                  shape,
                  body,
                  ...
                  if (!(this.skipBackfaces && normal.dot(this.direction) > 0))
                    switch (
                      ((result.hitFaceIndex =
                        void 0 !== hitFaceIndex ? hitFaceIndex : -1),
                      this.mode)
                    ) {
                      case Ray.ALL:
                        (this.hasHit = !0),
          ...
          Ray.prototype[Shape.types.HEIGHTFIELD] =
            Ray.prototype._intersectHeightfield;
          ...
          Ray.prototype[Shape.types.CONVEXPOLYHEDRON] =
            Ray.prototype._intersectConvex;
          ...
          var JacobianElement = (function () {
              ...
              return (
                (_proto.multiplyElement = function (element) {
                  return (
            ...
            Equation = (function () {
              ...
              return (
                (_proto.setSpookParams = function (
                  stiffness,
                  relaxation,
                  timeStep
                ) {
          ...
          var iMfi = new Vec3(),
            ...
            ContactEquation = (function (_Equation) {
              function ContactEquation(bodyA, bodyB, maxForce) {
                ...
                return (
                  void 0 === maxForce && (maxForce = 1e6),
                  ((_this =
                    _Equation.call(this, bodyA, bodyB, 0, maxForce) ||
                    this).restitution = 0),
                  (_this.ri = new Vec3()),
                  (_this.rj = new Vec3()),
                  (_this.ni = new Vec3()),
            ...
            PointToPointConstraint = (function (_Constraint) {
              function PointToPointConstraint(
                ...
                void 0 === pivotA && (pivotA = new Vec3()),
                  ...
                  void 0 === maxForce && (maxForce = 1e6),
                  ((_this = _Constraint.call(this, bodyA, bodyB) || this).pivotA =
                    pivotA.clone()),
            ...
            ConeEquation = (function (_Equation) {
              function ConeEquation(bodyA, bodyB, options) {
                ...
                void 0 === options && (options = {});
                var maxForce =
                  void 0 !== options.maxForce ? options.maxForce : 1e6;
                return (
                  ((_this =
                    _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) ||
              ...
              return (
                ...
                (ConeEquation.prototype.computeB = function (h) {
                  ...
                  return (
                    ...
                    -(Math.cos(this.angle) - ni.dot(nj)) * a -
                      this.computeGW() * b -
                      h * this.computeGiMf()
                  );
                }),
              ...
              return (
                ...
                (RotationalEquation.prototype.computeB = function (h) {
                  ...
                  return (
                    ...
                    GA.rotational.copy(njxni),
                    GB.rotational.copy(nixnj),
                    -(Math.cos(this.maxAngle) - ni.dot(nj)) * a -
                      this.computeGW() * b -
                      h * this.computeGiMf()
                  );
                }),
            ...
            ConeTwistConstraint = (function (_PointToPointConstrai) {
              function ConeTwistConstraint(bodyA, bodyB, options) {
                ...
                ((_this =
                  ...
                  (_this.angle = void 0 !== options.angle ? options.angle : 0);
                var c = (_this.coneEquation = new ConeEquation(
                    bodyA,
                    bodyB,
                    options
                  )),
                  t = (_this.twistEquation = new RotationalEquation(
                    bodyA,
                    bodyB,
                    options
                  ));
                return (
                  (_this.twistAngle =
                    void 0 !== options.twistAngle ? options.twistAngle : 0),
                  (c.maxForce = 0),
                  (c.minForce = -maxForce),
                  (t.maxForce = 0),
                  (t.minForce = -maxForce),
            ...
            DistanceConstraint =
              ...
              (function (_Constraint) {
                function DistanceConstraint(bodyA, bodyB, distance, maxForce) {
                  ...
                  var eq = (_this.distanceEquation = new ContactEquation(
                    bodyA,
                    bodyB
                  ));
                  return (
            ...
            LockConstraint = (function (_PointToPointConstrai) {
              function LockConstraint(bodyA, bodyB, options) {
                ...
                var r1 = (_this.rotationalEquation1 = new RotationalEquation(
                    bodyA,
                    bodyB,
                    options
                  )),
                  r2 = (_this.rotationalEquation2 = new RotationalEquation(
                    bodyA,
                    bodyB,
                    options
                  )),
                  r3 = (_this.rotationalEquation3 = new RotationalEquation(
                    bodyA,
                    bodyB,
                    options
                  ));
                ...
                return (
                  ...
                  (RotationalMotorEquation.prototype.computeB = function (h) {
                    ...
                    return (
                      ...
                      -(this.computeGW() - this.targetVelocity) * b -
                        h * this.computeGiMf()
                    );
                  }),
                  RotationalMotorEquation
              ...
              function HingeConstraint(bodyA, bodyB, options) {
                ...
                ((_this =
                  ...
                  (_this.axisB = options.axisB
                    ...
                    : new Vec3(1, 0, 0)).normalize(),
                  (_this.collideConnected = !!options.collideConnected);
                var rotational1 = (_this.rotationalEquation1 =
                    new RotationalEquation(bodyA, bodyB, options)),
                  rotational2 = (_this.rotationalEquation2 =
                    new RotationalEquation(bodyA, bodyB, options)),
                  motor = (_this.motorEquation = new RotationalMotorEquation(
                    bodyA,
                    bodyB,
                    maxForce
                  ));
            ...
            FrictionEquation = (function (_Equation) {
              function FrictionEquation(bodyA, bodyB, slipForce) {
                ...
                return (
                  ((_this =
                    _Equation.call(this, bodyA, bodyB, -slipForce, slipForce) ||
                    this).ri = new Vec3()),
                  (_this.rj = new Vec3()),
                  (_this.t = new Vec3()),
                  _this
          ...
          var Material = function Material(options) {
            ...
            "string" == typeof options && ((name = options), (options = {})),
              ...
              (this.friction =
                void 0 !== options.friction ? options.friction : -1),
              (this.restitution =
                void 0 !== options.restitution ? options.restitution : -1);
          };
          ...
          var Spring = (function () {
              function Spring(bodyA, bodyB, options) {
                void 0 === options && (options = {}),
                  (this.restLength =
                    "number" == typeof options.restLength
                      ? options.restLength
                      : 1),
                  ...
                  options.worldAnchorA &&
                    this.setWorldAnchorA(options.worldAnchorA),
                  options.worldAnchorB &&
                    this.setWorldAnchorB(options.worldAnchorB);
              }
              var _proto = Spring.prototype;
              return (
                (_proto.setWorldAnchorA = function (worldAnchorA) {
            ...
            RaycastVehicle = (function () {
              function RaycastVehicle(options) {
                (this.chassisBody = options.chassisBody),
                  ...
                  (this.world = null),
                  (this.indexRightAxis =
                    void 0 !== options.indexRightAxis
                      ? options.indexRightAxis
                      : 1),
                  (this.indexForwardAxis =
                    void 0 !== options.indexForwardAxis
                      ? options.indexForwardAxis
                      : 0),
                  (this.indexUpAxis =
                    void 0 !== options.indexUpAxis ? options.indexUpAxis : 2),
                  (this.constraints = []),
              ...
              return (
                (_proto.addWheel = function (options) {
                  void 0 === options && (options = {});
                ...
                (_proto.updateVehicle = function (timeStep) {
                  ...
                  for (
                    var impulse = new Vec3(), relpos = new Vec3(), _i2 = 0;
                    _i2 < numWheels;
                    _i2++
                  ) {
                  ...
                  for (
                    ...
                    chassisBody.getVelocityAtWorldPoint(
                      _wheel.chassisConnectionPointWorld,
                      vel
                    );
                    var m = 1;
                    ...
                    if (_wheel.isInContact) {
                      ...
                      _wheel.raycastResult.hitNormalWorld.scale(
                        proj,
                        hitNormalWorldScaledWithProj
                      ),
                        fwd.vsub(hitNormalWorldScaledWithProj, fwd);
                      var proj2 = fwd.dot(vel);
                      _wheel.deltaRotation =
                        (m * proj2 * timeStep) / _wheel.radius;
                    }
                    (!_wheel.sliding && _wheel.isInContact) ||
                      0 === _wheel.engineForce ||
                      !_wheel.useCustomSlidingRotationalSpeed ||
                      (_wheel.deltaRotation =
                        (_wheel.engineForce > 0 ? 1 : -1) *
                        _wheel.customSlidingRotationalSpeed *
                        timeStep),
                      Math.abs(_wheel.brake) > Math.abs(_wheel.engineForce) &&
                        (_wheel.deltaRotation = 0),
                      (_wheel.rotation += _wheel.deltaRotation),
                      (_wheel.deltaRotation *= 0.99);
                  }
                }),
                (_proto.updateSuspension = function (deltaTime) {
                  for (
                    var chassisMass = this.chassisBody.mass,
                    ...
                    if (wheel.isInContact) {
                      ...
                      (force -=
                        (projected_rel_vel < 0
                          ...
                          : wheel.dampingRelaxation) * projected_rel_vel),
                ...
                (_proto.updateFriction = function (timeStep) {
                  ...
                  for (var _i4 = 0; _i4 < numWheels; _i4++) {
                    ...
                    if (_groundObject) {
                      var axlei = axle[_i4];
                      this.getWheelTransformWorld(_i4).vectorToWorldFrame(
                      ...
                      surfNormalWS.scale(proj, surfNormalWS_scaled_proj),
                        ...
                        (_wheel2.sideImpulse = resolveSingleBilateral(
                          chassisBody,
                          _wheel2.raycastResult.hitPointWorld,
                          _groundObject,
                          _wheel2.raycastResult.hitPointWorld,
                          axlei
                        )),
                  ...
                  for (var _i5 = 0; _i5 < numWheels; _i5++) {
                    ...
                    if (((_wheel3.slipInfo = 1), _groundObject2)) {
                      ...
                      rollingFriction = calcRollingFriction(
                        chassisBody,
                        _groundObject2,
                        _wheel3.raycastResult.hitPointWorld,
                        forwardWS[_i5],
                        maxImpulse
                      );
                      var factor =
                        maxImpulse /
                        (rollingFriction += _wheel3.engineForce * timeStep);
                    ...
                    if (
                      ...
                      _wheel3.skidInfo = 1;
                      var maximp =
                          _wheel3.suspensionForce *
                          timeStep *
                          _wheel3.frictionSlip,
                        maximpSquared = maximp * maximp;
                      _wheel3.forwardImpulse = rollingFriction;
                      var x = 0.5 * _wheel3.forwardImpulse,
                        y = 1 * _wheel3.sideImpulse,
                        impulseSquared = x * x + y * y;
                      if (
                        ((_wheel3.sliding = !1), impulseSquared > maximpSquared)
                      ) {
                  ...
                  for (var _i7 = 0; _i7 < numWheels; _i7++) {
                    var _wheel5 = wheelInfos[_i7],
                      rel_pos = new Vec3();
                    if (
                      (_wheel5.raycastResult.hitPointWorld.vsub(
                        chassisBody.position,
                        rel_pos
                      ),
          ...
          var Sphere = (function (_Shape) {
              function Sphere(radius) {
                ...
                if (
                  (((_this =
                    _Shape.call(this, { type: Shape.types.SPHERE }) ||
              ...
              function RigidVehicle(options) {
                void 0 === options && (options = {}),
                  ...
                  (this.coordinateSystem =
                    void 0 !== options.coordinateSystem
                ...
                (_proto.addWheel = function (options) {
                  ...
                  void 0 === options && (options = {}),
                    (wheelBody = options.body
                      ? options.body
                      : new Body({ mass: 1, shape: new Sphere(1.2) })),
                    this.wheelBodies.push(wheelBody),
                    this.wheelForces.push(0);
                  new Vec3();
                  var position =
                      void 0 !== options.position
                ...
                (_proto.update = function () {
                  ...
                  for (
                    ...
                    for (
                      var Pij = void 0,
                        nabla = void 0,
                        _neighbors = this.neighbors[_i],
                        _numNeighbors = _neighbors.length,
                        _j = 0;
                      _j !== _numNeighbors;
                      _j++
                    ) {
                      ...
                      (Pij =
                        -neighbor.mass *
                        (this.pressures[_i] /
                          (this.densities[_i] * this.densities[_i] + eps) +
                          this.pressures[_j] /
                            (this.densities[_j] * this.densities[_j] + eps))),
                        this.gradw(r_vec, gradW),
                        gradW.scale(Pij, gradW),
                        a_pressure.vadd(gradW, a_pressure),
                        neighbor.velocity.vsub(particle.velocity, u),
                        u.scale(
                          (1 / (1e-4 + this.densities[_i] * this.densities[_j])) *
                            this.viscosity *
                            neighbor.mass,
                          u
                        ),
            ...
            Particle = (function (_Shape) {
              function Particle() {
                return _Shape.call(this, { type: Shape.types.PARTICLE }) || this;
              }
            ...
            Plane = (function (_Shape) {
              function Plane() {
                ...
                return (
                  ((_this =
                    _Shape.call(this, { type: Shape.types.PLANE }) ||
              ...
              return (
                (_proto.computeWorldNormal = function (quat) {
            ...
            Heightfield = (function (_Shape) {
              function Heightfield(data, options) {
                ...
                return (
                  ...
                  ((_this =
                    _Shape.call(this, { type: Shape.types.HEIGHTFIELD }) ||
                    this).data = data),
              ...
              return (
                ...
                (_proto.getCacheConvexTrianglePillarKey = function (
                  xi,
                  yi,
                  getUpperTriangle
                ) {
                ...
                (_proto.getCachedConvexTrianglePillar = function (
                  xi,
                  yi,
                  getUpperTriangle
                ) {
                ...
                (_proto.setCachedConvexTrianglePillar = function (
                  xi,
                  yi,
                  getUpperTriangle,
                  convex,
                ...
                (_proto.clearCachedConvexTrianglePillar = function (
                  xi,
                  yi,
                  getUpperTriangle
                ) {
                ...
                (_proto.getConvexTrianglePillar = function (
                  xi,
                  yi,
                  getUpperTriangle
                ) {
                  ...
                  if (this.cacheEnabled) {
                    var _data = this.getCachedConvexTrianglePillar(
                      xi,
                      yi,
                      getUpperTriangle
                    );
                    if (_data)
                      return (
                        ...
                        void (this.pillarOffset = _data.offset)
                      );
                ...
                (_proto.setHeightsFromImage = function (image, scale) {
                  ...
                  for (var i = 0; i < imageData.height; i++) {
                    for (var row = [], j = 0; j < imageData.width; j++) {
                      var height =
                        ((imageData.data[4 * (i * imageData.height + j)] +
                          imageData.data[4 * (i * imageData.height + j) + 1] +
                          imageData.data[4 * (i * imageData.height + j) + 2]) /
                          4 /
                          255) *
                        z;
          ...
          var Octree = (function (_OctreeNode) {
              function Octree(aabb, options) {
                ...
                return (
                  void 0 === options && (options = {}),
                  ((_this =
                    _OctreeNode.call(this, { root: null, aabb: aabb }) ||
                    this).maxDepth =
                    void 0 !== options.maxDepth ? options.maxDepth : 8),
                  _this
                );
              }
            ...
            Trimesh = (function (_Shape) {
              function Trimesh(vertices, indices) {
                ...
                return (
                  ((_this =
                    _Shape.call(this, { type: Shape.types.TRIMESH }) ||
              ...
              return (
                ...
                (_proto.getEdgeVertex = function (
                  edgeIndex,
                  firstOrSecond,
                  vertexStore
                ) {
                  var vertexIndex =
                    this.edges[2 * edgeIndex + (firstOrSecond ? 1 : 0)];
          ...
          var Solver = (function () {
            ...
            GSSolver = (function (_Solver) {
              function GSSolver() {
                var _this;
                return (
                  ((_this = _Solver.call(this) || this).iterations = 10),
                      ...
                      for (var j = 0; j !== Neq; j++) {
                        ...
                        (B = Bs[j]),
                          ...
                          (lambdaj = lambda[j]) +
                            (deltalambda =
                              invC *
                              (B - _c.computeGWlambda() - _c.eps * lambdaj)) <
                          _c.minForce
                            ? (deltalambda = _c.minForce - lambdaj)
                            : lambdaj + deltalambda > _c.maxForce &&
            ...
            SplitSolver = (function (_Solver) {
              ...
              return (
                (_proto.createNode = function () {
                  return { body: null, children: [], eqs: [], visited: !1 };
                }),
                (_proto.solve = function (dt, world) {
                  for (
                    var child,
                      nodes = SplitSolver_solve_nodes,
          ...
          function bfs(root, visitFunc, bds, eqs) {
            for (
              ...
              for (
                var _node3 = queue.pop(), child = void 0;
                (child = getUnvisitedNode(_node3.children));
          ...
          var Pool = (function () {
            ...
            Narrowphase = (function () {
              ...
              return (
                (_proto.createContactEquation = function (
                  bi,
                  bj,
                  si,
                  sj,
                  ...
                  this.contactPointPool.length
                    ? (((c = this.contactPointPool.pop()).bi = bi), (c.bj = bj))
                ...
                (_proto.createFrictionEquationsFromContact = function (
                  contactEquation,
                  outArray
                ) {
                ...
                (_proto.createFrictionFromAverage = function (numContacts) {
                  ...
                  if (
                    ...
                    for (var bodyA = c.bi, i = (c.bj, 0); i !== numContacts; i++)
                      (c = this.result[this.result.length - 1 - i]).bi !== bodyA
                ...
                (_proto.sphereBox = function (
                  ...
                  for (
                    ...
                    if (dot < h + R && dot > 0) {
                      ...
                      if (dot1 < h1 && dot1 > -h1 && dot2 < h2 && dot2 > -h2) {
                        ...
                        if (
                          (null === side_distance || _dist < side_distance) &&
                          ((side_distance = _dist),
                          (side_dot1 = dot1),
                          (side_dot2 = dot2),
                          (side_h = h),
                  ...
                  for (
                    var rj = v3pool.get(),
                      sphere_to_corner = sphereBox_sphere_to_corner,
                      j = 0;
                    2 !== j && !found;
                    j++
                  )
                    for (var k = 0; 2 !== k && !found; k++)
                      for (var l = 0; 2 !== l && !found; l++)
                        if (
                          ...
                          sphere_to_corner.lengthSquared() < R * R)
                        ) {
                          if (justTest) return !0;
                          found = !0;
                          var _r2 = this.createContactEquation(
                            bi,
                            bj,
                            si,
                            sj,
                ...
                (_proto.sphereConvex = function (
                  ...
                  for (
                    ...
                    if (
                      ...
                      for (
                        var faceVerts = [], j = 0, Nverts = face.length;
                        j !== Nverts;
                        j++
                      ) {
                      ...
                      if (pointInPolygon(faceVerts, worldNormal, xi)) {
                        if (justTest) return !0;
                        found = !0;
                        var _r3 = this.createContactEquation(
                          bi,
                          bj,
                          si,
                          sj,
                        ...
                        for (
                          var _j2 = 0, Nfaceverts = faceVerts.length;
                          _j2 !== Nfaceverts;
                          _j2++
                        )
                      ...
                      for (var _j3 = 0; _j3 !== face.length; _j3++) {
                        ...
                        if (
                          ...
                          if (justTest) return !0;
                          var _r4 = this.createContactEquation(
                            bi,
                            bj,
                            si,
                            sj,
                          ...
                          for (
                            var _j4 = 0, _Nfaceverts = faceVerts.length;
                            _j4 !== _Nfaceverts;
                            _j4++
                          )
                      ...
                      for (
                        var _j5 = 0, _Nfaceverts2 = faceVerts.length;
                        _j5 !== _Nfaceverts2;
                        _j5++
                      )
                ...
                (_proto.planeConvex = function (
                  ...
                  for (
                    var numContacts = 0, relpos = planeConvex_relpos, i = 0;
                    i !== convexShape.vertices.length;
                    i++
                  ) {
                    if (
                ...
                (_proto.sphereHeightfield = function (
                  sphereShape,
                  hfShape,
                  spherePos,
                  hfPos,
                ...
                (_proto.boxHeightfield = function (
                  si,
                  sj,
                  xi,
                  xj,
                ...
                (_proto.convexHeightfield = function (
                  convexShape,
                  hfShape,
                  convexPos,
                  hfPos,
                ...
                (_proto.sphereParticle = function (
                  sj,
                  si,
                  xj,
                  xi,
                  ...
                  if (
                    (normal.set(0, 0, 1),
                    xi.vsub(xj, normal),
                    normal.lengthSquared() <= sj.radius * sj.radius)
                  ) {
                    if (justTest) return !0;
                    var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                    normal.normalize(),
                ...
                (_proto.convexParticle = function (
                  sj,
                  si,
                  xj,
                  xi,
                  ...
                  if (
                    ...
                    sj.worldVerticesNeedsUpdate &&
                      sj.computeWorldVertices(xj, qj),
                      sj.worldFaceNormalsNeedsUpdate &&
                        sj.computeWorldFaceNormals(qj);
                    for (var i = 0, nfaces = sj.faces.length; i !== nfaces; i++) {
                      var verts = [sj.worldVertices[sj.faces[i][0]]],
                        normal = sj.worldFaceNormals[i];
                      xi.vsub(verts[0], convexParticle_vertexToParticle);
                      var penetration = -normal.dot(
                ...
                (_proto.sphereTrimesh = function (
                  ...
                  for (
                    var v = sphereTrimesh_v,
                      radiusSquared = sphereShape.radius * sphereShape.radius,
                      i = 0;
                    i < triangles.length;
                    i++
                  )
                    for (var j = 0; j < 3; j++)
                      if (
                        (trimeshShape.getVertex(
                          trimeshShape.indices[3 * triangles[i] + j],
                          v
                        ),
                        v.vsub(localSpherePos, relpos),
                        relpos.lengthSquared() <= radiusSquared)
                      ) {
                        if (
                          (v2.copy(v),
                          Transform.pointToWorldFrame(
                  ...
                  for (var _i2 = 0; _i2 < triangles.length; _i2++)
                    for (var _j6 = 0; _j6 < 3; _j6++) {
                      trimeshShape.getVertex(
                        trimeshShape.indices[3 * triangles[_i2] + _j6],
                        edgeVertexA
                      ),
                        trimeshShape.getVertex(
                          trimeshShape.indices[
                            3 * triangles[_i2] + ((_j6 + 1) % 3)
                          ],
                          edgeVertexB
                        ),
                      ...
                      if (positionAlongEdgeA > 0 && positionAlongEdgeB < 0)
                        if (
                          ...
                          tmp.distanceTo(localSpherePos) < sphereShape.radius)
                        ) {
                          if (justTest) return !0;
                          var _r5 = this.createContactEquation(
                            sphereBody,
                            trimeshBody,
                            sphereShape,
                            trimeshShape,
                  ...
                  for (
                    ...
                    if (
                      ...
                      Ray.pointInTriangle(tmp, va, vb, vc) &&
                        _dist2 < sphereShape.radius)
                    ) {
                      if (justTest) return !0;
                      var _r6 = this.createContactEquation(
                        sphereBody,
                        trimeshBody,
                        sphereShape,
                        trimeshShape,
          ...
          (Narrowphase.prototype[COLLISION_TYPES.boxBox] =
          ...
          function pointInPolygon(verts, normal, p) {
            for (
              var positiveResult = null, N = verts.length, i = 0;
              i !== N;
              i++
            ) {
              var v = verts[i],
          ...
          var OverlapKeeper = (function () {
            ...
            return (
              ...
              (_proto.set = function (i, j) {
                for (
                  var key = this.getKey(i, j), current = this.current, index = 0;
                  key > current[index];
          ...
          var TupleDictionary = (function () {
            ...
            World = (function (_EventTarget) {
              function World(options) {
                ...
                return (
                  ...
                  (_this.quatNormalizeSkip =
                    void 0 !== options.quatNormalizeSkip
                      ? options.quatNormalizeSkip
                      : 0),
                  (_this.quatNormalizeFast =
                    void 0 !== options.quatNormalizeFast &&
                  ...
                  (_this.broadphase =
                    void 0 !== options.broadphase
                      ? options.broadphase
                      : new NaiveBroadphase()),
                  (_this.bodies = []),
                  (_this.hasActiveBodies = !1),
                  (_this.solver =
                    void 0 !== options.solver ? options.solver : new GSSolver()),
                  (_this.constraints = []),
                  (_this.narrowphase = new Narrowphase(
                  ...
                  (_this.defaultContactMaterial = new ContactMaterial(
                    _this.defaultMaterial,
                    _this.defaultMaterial,
                  ...
                  (_this.accumulator = 0),
                  (_this.subsystems = []),
                  (_this.addBodyEvent = { type: "addBody", body: null }),
                  (_this.removeBodyEvent = { type: "removeBody", body: null }),
                  (_this.idToBodyMap = {}),
              ...
              return (
                (_proto.getContactMaterial = function (m1, m2) {
                ...
                (_proto.getShapeById = function (id) {
                  for (
                    var bodies = this.bodies, i = 0, bl = bodies.length;
                    i < bl;
                    i++
                  )
                    for (
                      var shapes = bodies[i].shapes, j = 0, sl = shapes.length;
                      j < sl;
                      j++
                    ) {
                      var shape = shapes[j];
                ...
                (_proto.step = function (dt, timeSinceLastCalled, maxSubSteps) {
                  if (
                    (void 0 === timeSinceLastCalled && (timeSinceLastCalled = 0),
                    void 0 === maxSubSteps && (maxSubSteps = 10),
                    ...
                    for (
                      var substeps = 0;
                      this.accumulator >= dt && substeps < maxSubSteps;
  
                    )
                      this.internalStep(dt), (this.accumulator -= dt), substeps++;
                    for (
                      var t = (this.accumulator % dt) / dt, j = 0;
                ...
                (_proto.internalStep = function (dt) {
                  ...
                  for (
                    var _i = 0, Nsubsystems = this.subsystems.length;
                    _i !== Nsubsystems;
                    _i++
                  )
                  ...
                  for (
                    var ncontacts = contacts.length, k = 0;
                    k !== ncontacts;
                    k++
                  ) {
                    var _c = contacts[k],
                    ...
                    (
                      (_bi.material &&
                        bj.material &&
                        this.getContactMaterial(_bi.material, bj.material)) ||
                      this.defaultContactMaterial
                    ).friction;
                    if (
                      (_bi.material &&
                        bj.material &&
                        (_bi.material.friction >= 0 &&
                          bj.material.friction >= 0 &&
                          _bi.material.friction * bj.material.friction,
                        _bi.material.restitution >= 0 &&
                          bj.material.restitution >= 0 &&
                          (_c.restitution =
                            _bi.material.restitution * bj.material.restitution)),
                      solver.addEquation(_c),
                      _bi.allowSleep &&
                        _bi.type === Body.DYNAMIC &&
                        _bi.sleepState === Body.SLEEPING &&
                        bj.sleepState === Body.AWAKE &&
                        bj.type !== Body.STATIC)
                    )
                      bj.velocity.lengthSquared() +
                        bj.angularVelocity.lengthSquared() >=
                        2 * Math.pow(bj.sleepSpeedLimit, 2) &&
                        (_bi.wakeUpAfterNarrowphase = !0);
                    if (
                      bj.allowSleep &&
                      bj.type === Body.DYNAMIC &&
                      bj.sleepState === Body.SLEEPING &&
                      _bi.sleepState === Body.AWAKE &&
                      _bi.type !== Body.STATIC
                    )
                      _bi.velocity.lengthSquared() +
                        _bi.angularVelocity.lengthSquared() >=
                        2 * Math.pow(_bi.sleepSpeedLimit, 2) &&
                        (bj.wakeUpAfterNarrowphase = !0);
                    this.collisionMatrix.set(_bi, bj, !0),
                      this.collisionMatrixPrevious.get(_bi, bj) ||
                  ...
                  for (
                    ...
                    var _bi2 = bodies[i];
                    _bi2.wakeUpAfterNarrowphase &&
                      (_bi2.wakeUp(), (_bi2.wakeUpAfterNarrowphase = !1));
                  }
                  for (
                    Nconstraints = constraints.length, i = 0;
                    i !== Nconstraints;
                    i++
                  ) {
                    ...
                    _c2.update();
                    for (
                      var _j = 0, Neq = _c2.equations.length;
                      _j !== Neq;
                      _j++
                    ) {
                  ...
                  for (
                    this.dispatchEvent(World_step_preStepEvent), i = 0;
                    i !== N;
                    i++
                  ) {
                    var _bi4 = bodies[i];
          ...
          (World.prototype.emitContactEvents =
            ...
            function () {
              ...
              if (
                ((hasBeginShapeContact || hasEndShapeContact) &&
            ...
            (exports.BODY_TYPES = { DYNAMIC: 1, STATIC: 2, KINEMATIC: 4 }),
            (exports.Body = Body),
            (exports.Box = Box),
            ...
            (exports.RAY_MODES = { CLOSEST: 1, ANY: 2, ALL: 4 }),
            (exports.Ray = Ray),
        ...
        function (require, module, exports) {
          ...
          function _setOptions(options) {
            (options.fit = options.hasOwnProperty("fit") ? options.fit : FIT.ALL),
              ...
              (options.margin = options.hasOwnProperty("margin")
                ? options.margin
                : 0.01),
              (options.includeInvisible =
                !!options.hasOwnProperty("includeInvisible") &&
                options.includeInvisible),
          ...
          (exports.createCollisionShapes = function (root, options) {
            ...
            (exports.createSphereShape = function (root, options) {
              ...
              (options.type = TYPE.SPHERE),
                _setOptions(options),
                (radius =
                  options.fit !== FIT.MANUAL || isNaN(options.sphereRadius)
                    ? _computeRadius(root, options, _computeBounds(root, options))
            ...
            (exports.createHullShape = (function () {
              ...
              return function (root, options) {
                if (
                  ...
                  _setOptions(options),
                  options.fit === FIT.MANUAL)
                )
                  return (
                    console.warn("cannot use fit: manual with type: hull"), null
                  );
                ...
                _iterateGeometries(root, options, (geo, transform) => {
                  ...
                  for (let i = 0; i < components.length; i += 3)
                    Math.random() <= p &&
                      ...
                      originalHull.addPoint(
                        btVertex,
                        i === components.length - 3
                      ));
                });
            ...
            (exports.createHACDShapes = (function () {
              ...
              return function (root, options) {
                ...
                options.hasOwnProperty("compacityWeight") &&
                  hacd.SetCompacityWeight(options.compacityWeight),
                  options.hasOwnProperty("volumeWeight") &&
                    hacd.SetVolumeWeight(options.volumeWeight),
                  options.hasOwnProperty("nClusters") &&
                    hacd.SetNClusters(options.nClusters),
                  options.hasOwnProperty("nVerticesPerCH") &&
                    hacd.SetNVerticesPerCH(options.nVerticesPerCH),
                  options.hasOwnProperty("concavity") &&
            ...
            (exports.createVHACDShapes = (function () {
              ...
              return function (root, options) {
                ...
                options.hasOwnProperty("resolution") &&
                  params.set_m_resolution(options.resolution),
                  options.hasOwnProperty("depth") &&
                    params.set_m_depth(options.depth),
                  options.hasOwnProperty("concavity") &&
                    params.set_m_concavity(options.concavity),
                  options.hasOwnProperty("planeDownsampling") &&
                    params.set_m_planeDownsampling(options.planeDownsampling),
                  options.hasOwnProperty("convexhullDownsampling") &&
                    params.set_m_convexhullDownsampling(
                      options.convexhullDownsampling
                    ),
                  options.hasOwnProperty("alpha") &&
                    params.set_m_alpha(options.alpha),
                  options.hasOwnProperty("beta") &&
                    params.set_m_beta(options.beta),
                  options.hasOwnProperty("gamma") &&
                  ...
                  options.hasOwnProperty("maxNumVerticesPerCH") &&
                    params.set_m_maxNumVerticesPerCH(options.maxNumVerticesPerCH),
                  options.hasOwnProperty("minVolumePerCH") &&
                    params.set_m_minVolumePerCH(options.minVolumePerCH),
                  options.hasOwnProperty("convexhullApproximation") &&
                    params.set_m_convexhullApproximation(
                      options.convexhullApproximation
                    ),
                  options.hasOwnProperty("oclAcceleration") &&
            ...
            (exports.createTriMeshShape = (function () {
              ...
              return function (root, options) {
                if (
                  ...
                  return (
                    console.warn("cannot use fit: manual with type: mesh"), null
                  );
                ...
                const collisionShape = new Ammo.btBvhTriangleMeshShape(
                  triMesh,
                  !0,
                  !0
                );
            ...
            (exports.createHeightfieldTerrainShape = function (root, options) {
              if ((_setOptions(options), options.fit === FIT.ALL))
                return (
                  console.warn("cannot use fit: all with type: heightfield"), null
                );
              const heightfieldDistance = options.heightfieldDistance || 1,
                ...
                flipQuadEdges =
                  !options.hasOwnProperty("flipQuadEdges") ||
              ...
              (collisionShape.type = options.type),
                ...
                (collisionShape.destroy = () => {
                  for (let res of collisionShape.resources || [])
                    Ammo.destroy(res);
                  collisionShape.heightfieldData &&
                ...
                inverse.getInverse(root.matrixWorld),
                  root.traverse((mesh) => {
                    !mesh.isMesh ||
                      ...
                      (mesh === root
                        ? transform.identity()
                        : (hasUpdateMatricesFunction && mesh.updateMatrices(),
          ...
          (function (global) {
            var e = require("cannon-es"),
              ...
              n = (function () {
                ...
                function a() {
                  (this.tolerance = -1),
                    ...
                    (this.newFaces = []),
                    (this.assigned = new l()),
                    (this.unassigned = new l()),
                    (this.vertices = []);
                }
                function s() {
                  (this.normal = new t.Vector3()),
                    (this.midpoint = new t.Vector3()),
                    (this.area = 0),
                    (this.constant = 0),
                    (this.outside = null),
                    (this.mark = 0),
                ...
                return (
                  Object.assign(a.prototype, {
                    setFromPoints: function (e) {
                      !0 !== Array.isArray(e) &&
                        console.error(
                          "THREE.ConvexHull: Points parameter is not an array."
                        ),
                        e.length < 4 &&
                          console.error(
                          ...
                          if (void 0 !== a)
                            if (a.isGeometry) {
                              ...
                              for (r = 0, i = s.length; r < i; r++)
                                (o = s[r].clone()).applyMatrix4(e.matrixWorld),
                                  n.push(o);
                            } else if (a.isBufferGeometry) {
                              var u = a.attributes.position;
                              if (void 0 !== u)
                                for (r = 0, i = u.count; r < i; r++)
                                  (o = new t.Vector3())
                                    .fromBufferAttribute(u, r)
                    ...
                    intersectRay: function (e, t) {
                      for (
                        ...
                        var s = n[o],
                          u = s.distanceToPoint(e.origin),
                          h = s.normal.dot(e.direction);
                        if (u > 0 && h >= 0) return null;
                        var l = 0 !== h ? -u / h : 0;
                        if (
                          !(l <= 0) &&
                          (h > 0 ? (i = Math.min(l, i)) : (r = Math.max(l, r)),
                          r > i)
                        )
                          return null;
                      }
                    ...
                    addVertexToFace: function (e, t) {
                      return (
                        (e.face = t),
                        null === t.outside
                          ? this.assigned.append(e)
                          : this.assigned.insertBefore(t.outside, e),
                        (t.outside = e),
                        this
                      );
                    },
                    removeVertexFromFace: function (e, t) {
                      return (
                        e === t.outside &&
                          (t.outside =
                            null !== e.next && e.next.face === t ? e.next : null),
                        this.assigned.remove(e),
                        this
                      );
                    },
                    removeAllVerticesFromFace: function (e) {
                      if (null !== e.outside) {
                        for (
                          var t = e.outside, n = e.outside;
                          null !== n.next && n.next.face === e;
  
                        )
                          n = n.next;
                        return (
                          this.assigned.removeSubList(t, n),
                          (t.prev = n.next = null),
                          (e.outside = null),
                          t
                        );
                    ...
                    deleteFaceVertices: function (e, t) {
                      ...
                      if (void 0 !== n)
                        if (void 0 === t) this.unassigned.appendChain(n);
                          ...
                          do {
                            var i = r.next;
                            t.distanceToPoint(r.point) > this.tolerance
                              ? this.addVertexToFace(r, t)
                              : this.unassigned.append(r),
                              (r = i);
                          } while (null !== r);
                        }
                      return this;
                    ...
                    resolveUnassignedPoints: function (e) {
                      if (!1 === this.unassigned.isEmpty()) {
                        ...
                        do {
                          for (
                            var n = t.next, r = this.tolerance, i = null, o = 0;
                            o < e.length;
                            o++
                          ) {
                            var a = e[o];
                    ...
                    computeExtremes: function () {
                      ...
                      for (
                        ...
                        var u = this.vertices[e],
                          h = u.point;
                        for (r = 0; r < 3; r++)
                          h.getComponent(r) < i.getComponent(r) &&
                            (i.setComponent(r, h.getComponent(r)), (a[r] = u));
                        for (r = 0; r < 3; r++)
                          h.getComponent(r) > o.getComponent(r) &&
                            (o.setComponent(r, h.getComponent(r)), (s[r] = u));
                      }
                      return (
                        (this.tolerance =
                          3 *
                          Number.EPSILON *
                          (Math.max(Math.abs(i.x), Math.abs(o.x)) +
                            Math.max(Math.abs(i.y), Math.abs(o.y)) +
                            Math.max(Math.abs(i.z), Math.abs(o.z)))),
                        { min: a, max: s }
                      );
                    },
                    computeInitialHull: function () {
                      ...
                      for (l = 0; l < 3; l++)
                        (m =
                          g[l].point.getComponent(l) -
                          v[l].point.getComponent(l)) > x && ((x = m), (y = l));
                      for (
                        x = 0,
                          e.set((o = v[y]).point, (a = g[y]).point),
                          l = 0,
                        ...
                        (i = p[l]) !== o &&
                          i !== a &&
                          (e.closestPointToPoint(i.point, !0, r),
                          (m = r.distanceToSquared(i.point)) > x &&
                            ((x = m), (u = i)));
                      for (
                        x = -1,
                          n.setFromCoplanarPoints(o.point, a.point, u.point),
                          l = 0,
                          c = this.vertices.length;
                        l < c;
                        l++
                        ...
                        (i = p[l]) !== o &&
                          i !== a &&
                          i !== u &&
                          (m = Math.abs(n.distanceToPoint(i.point))) > x &&
                          ((x = m), (h = i));
                      var w = [];
                      if (n.distanceToPoint(h.point) < 0)
                        for (
                          ...
                          (d = (l + 1) % 3),
                            w[l + 1].getEdge(2).setTwin(w[0].getEdge(d)),
                            w[l + 1].getEdge(1).setTwin(w[d + 1].getEdge(0));
                      else
                        for (
                          w.push(
                            s.create(o, u, a),
                    ...
                    computeHorizon: function (e, t, n, r) {
                      var i;
                      this.deleteFaceVertices(n),
                        (n.mark = 1),
                        (i = null === t ? (t = n.getEdge(0)) : t.next);
                      do {
                        var o = i.twin,
                          a = o.face;
                        0 === a.mark &&
                          (a.distanceToPoint(e) > this.tolerance
                            ? this.computeHorizon(e, o, a, r)
                            : r.push(i)),
                          (i = i.next);
                      } while (i !== t);
                      return this;
                    ...
                    addNewFaces: function (e, t) {
                      ...
                      for (var n = null, r = null, i = 0; i < t.length; i++) {
                        ...
                        null === n ? (n = o) : o.next.setTwin(r),
                          this.newFaces.push(o.face),
                          (r = o);
                      }
                    ...
                    addVertexToHull: function (e) {
                      ...
                      return (
                        ...
                        this.computeHorizon(e.point, null, e.face, t),
                        this.addNewFaces(e, t),
                  ...
                  Object.assign(l.prototype, {
                    ...
                    insertBefore: function (e, t) {
                      return (
                        (t.prev = e.prev),
                        (t.next = e),
                        null === t.prev ? (this.head = t) : (t.prev.next = t),
                        (e.prev = t),
                        this
                      );
                    },
                    insertAfter: function (e, t) {
                      return (
                        (t.prev = e),
                        (t.next = e.next),
                        null === t.next ? (this.tail = t) : (t.next.prev = t),
                        (e.next = t),
                        this
                      );
                    },
              ...
              o = function (o, l) {
                ...
                if (l.type === i.CYLINDER)
                  return (function (n, i) {
                    var o = ["x", "y", "z"],
                      a = i.cylinderAxis || "y",
                      s = o.splice(o.indexOf(a), 1) && o,
                      u = new t.Box3().setFromObject(n);
                    if (!isFinite(u.min.lengthSq())) return null;
                    var h = u.max[a] - u.min[a],
                      l =
                        0.5 *
                        Math.max(
                          u.max[s[0]] - u.min[s[0]],
                      ...
                      c = new e.Cylinder(l, l, h, 12);
                    return (
                      (c._type = e.Shape.types.CYLINDER),
                      (c.radiusTop = l),
                      (c.radiusBottom = l),
                      (c.height = h),
                      (c.numSegments = 12),
                      (c.orientation = new e.Quaternion()),
                      c.orientation
                        .setFromEuler(
                          "y" === a ? r : 0,
                          "z" === a ? r : 0,
                ...
                if (l.type === i.HULL)
                  return (function (r) {
                    ...
                    for (var o = 0; o < i.vertices.length; o++)
                      (i.vertices[o].x += 1e-4 * (Math.random() - 0.5)),
                        (i.vertices[o].y += 1e-4 * (Math.random() - 0.5)),
                        (i.vertices[o].z += 1e-4 * (Math.random() - 0.5));
                    var a = new n().setFromObject(new t.Mesh(i)).faces,
                      s = [],
                      h = [];
                    for (o = 0; o < a.length; o++) {
                      ...
                      do {
                        var d = c.head().point;
                        s.push(new e.Vec3(d.x, d.y, d.z)),
                          h.push(new e.Vec3(l.normal.x, l.normal.y, l.normal.z)),
                          (c = c.next);
                      } while (c !== l.edge);
                    }
                    return new e.ConvexPolyhedron({ vertices: s, normals: h });
                  })(o);
                if (l.type === i.MESH)
                  return (c = u(o))
                    ? (function (t) {
                ...
                switch (c.metadata ? c.metadata.type : c.type) {
                  ...
                  case "CylinderBufferGeometry":
                    return (function (n) {
                      var r = n.metadata ? n.metadata.parameters : n.parameters,
                        i = new e.Cylinder(
                          r.radiusTop,
                          r.radiusBottom,
                          r.height,
                      ...
                      return (
                        (i._type = e.Shape.types.CYLINDER),
                        (i.radiusTop = r.radiusTop),
                        (i.radiusBottom = r.radiusBottom),
                        (i.height = r.height),
                        (i.numSegments = r.radialSegments),
                        (i.orientation = new e.Quaternion()),
                        i.orientation
                          .setFromEuler(t.Math.degToRad(-90), 0, 0, "XYZ")
                          .normalize(),
                        i
                      );
                    })(c);
                  ...
                  case "PlaneBufferGeometry":
                    return (function (t) {
                      ...
                      return new e.Box(
                        new e.Vec3(
                          (n.max.x - n.min.x) / 2 || 0.1,
                          (n.max.y - n.min.y) / 2 || 0.1,
                          (n.max.z - n.min.z) / 2 || 0.1
                        )
                      );
                    })(c);
                  case "SphereGeometry":
                  case "SphereBufferGeometry":
                    return (function (t) {
                      return new e.Sphere(
                        (t.metadata ? t.metadata.parameters : t.parameters).radius
                      );
                    })(c);
                  case "TubeGeometry":
                  case "Geometry":
            ...
            function s(n) {
              ...
              var o = new e.Box(
                ...
                a = i.translate(r.position.negate()).getCenter(new t.Vector3());
                ...
                return (
                  r[0].geometry.isBufferGeometry
                    ? r[0].geometry.attributes.position &&
                      ...
                      i.fromBufferGeometry(r[0].geometry)
                    : (i = r[0].geometry.clone()),
                  (i.metadata = r[0].geometry.metadata),
                  r[0].updateMatrixWorld(),
                  r[0].matrixWorld.decompose(a, s, u),
                  i.scale(u.x, u.y, u.z)
                );
              }
              for (; (n = r.pop()); )
                if ((n.updateMatrixWorld(), n.geometry.isBufferGeometry)) {
                  if (
                    ...
                    h.fromBufferGeometry(n.geometry),
                      o.merge(h, n.matrixWorld),
                      h.dispose();
                  }
            ...
            function h(e) {
              return (
                e.attributes || (e = new t.BufferGeometry().fromGeometry(e)),
            ...
            update: function () {
              ...
              this.remove(),
                el.body && data.target.body
                  ...
                  : (el.body ? data.target : el).addEventListener(
                      "body-loaded",
              ...
              switch ((targetTransform.setIdentity(), data.type)) {
                ...
                case CONSTRAINT.FIXED:
                  bodyTransform.setRotation(
                    ...
                    targetTransform.setRotation(
                      targetBody.getWorldTransform().getRotation()
                    ),
                ...
                case CONSTRAINT.HINGE: {
                  const pivot = new Ammo.btVector3(
                    ...
                    targetPivot = new Ammo.btVector3(
                      data.targetPivot.x,
                      data.targetPivot.y,
                      data.targetPivot.z
                    ),
                    axis = new Ammo.btVector3(
                      data.axis.x,
                      data.axis.y,
                      data.axis.z
                    ),
                    targetAxis = new Ammo.btVector3(
                      data.targetAxis.x,
                      data.targetAxis.y,
                      data.targetAxis.z
                    );
      ...
      9: [
          ...
          let AmmoBody = {
              ...
              return function () {
                ...
                if (
                  ...
                  for (let i = 0; i < this.shapeComponents.length; i++) {
                    ...
                    0 === shapeComponent.getShapes().length &&
                ...
                if (
                  ...
                  for (let i = 0; i < this.shapeComponents.length; i++) {
                    ...
                    for (let j = 0; j < collisionShapes.length; j++) {
                      const collisionShape = collisionShapes[j];
                      -1 !==
                        needsPolyhedralInitialization.indexOf(
                          collisionShape.type
            ...
            _createCollisionShape: function (shapeComponent) {
              const data = shapeComponent.data,
                collisionShapes = threeToAmmo.createCollisionShapes(
              ...
              if (this.isLoaded) {
                ...
                if (
                  ...
                  prevData.activationState !== data.activationState &&
                    ...
                    data.activationState === ACTIVATION_STATE.ACTIVE_TAG &&
                      this.body.activate(!0)),
                  ...
                  broadphaseProxy.set_m_collisionFilterGroup(
                    data.collisionFilterGroup
                  ),
                    broadphaseProxy.set_m_collisionFilterMask(
                      data.collisionFilterMask
                    ),
                ...
                if (
                  ((prevData.linearSleepingThreshold ==
                    data.linearSleepingThreshold &&
            ...
            beforeStep: function () {
              this._updateShapes(),
                this.data.type !== TYPE.DYNAMIC && this.syncToPhysics();
            },
            step: function () {
        ...
        { "../../constants": 19, "ammo-debug-drawer": 3, "three-to-ammo": 5 },
      ],
      10: [
        function (require, module, exports) {
          var CANNON = require("cannon-es"),
          ...
          var q,
            ...
            Body = {
                  ...
                  ? shape
                    ? this.body
                      ? (this.body.addShape(shape, offset, orientation),
                        this.system.debug && (this.shouldUpdateWireframe = !0),
                        (this.shouldUpdateBody = !0))
                      : console.warn(
                          "shape cannot be added before body is loaded"
                        )
                    : console.warn("shape cannot be null")
                  : console.warn(
                      "shape can only be added if shape property is none"
                    );
              },
              tick: function () {
                this.shouldUpdateBody &&
                  ((this.isLoaded = !0),
                  this._play(),
                  this.el.emit("body-loaded", { body: this.el.body }),
                  (this.shouldUpdateBody = !1)),
                  this.shouldUpdateWireframe &&
              ...
              createWireframe: function (body) {
                ...
                for (
                  var orientation = new THREE.Quaternion(), i = 0;
                  i < this.body.shapes.length;
                  i++
                ) {
              ...
              syncWireframe: function () {
                ...
                this.wireframe &&
                  ...
                  wireframe.offset &&
                    ((offset = wireframe.offset
                      .clone()
                      .applyQuaternion(wireframe.quaternion)),
      ...
      12: [
        function (require, module, exports) {
          ...
          (StaticBody.schema = AFRAME.utils.extend({}, Body.definition.schema, {
            ...
            (module.exports = AFRAME.registerComponent(
              "static-body",
              StaticBody
            ));
        },
        ...
        function (require, module, exports) {
          ...
          module.exports = AFRAME.registerComponent("constraint", {
            ...
            createConstraint: function () {
              ...
              return (
                (constraint.collideConnected = data.collideConnected), constraint
              );
            },
          });
        },
        ...
        function (require, module, exports) {
          module.exports = {
            ...
            registerAll: function (AFRAME) {
              this._registered ||
                ((AFRAME = AFRAME || window.AFRAME).components.velocity ||
              ...
              if (dt) {
                ...
                (dt = Math.min(dt, 1e3 * physics.data.maxInterval)),
                  this.el.object3D.position.set(
                    position.x + (velocity.x * dt) / 1e3,
                    position.y + (velocity.y * dt) / 1e3,
                    position.z + (velocity.z * dt) / 1e3
                  );
              }
            },
          });
          ...
          var AmmoShape = {
            ...
            init: function () {
              ...
              for (
                ...
                !this.body && bodyEl.parentNode != this.el.sceneEl;
  
              )
                (bodyEl = bodyEl.parentNode).components["ammo-body"] &&
            ...
            Shape = {
              ...
              init: function () {
                this.el.sceneEl.hasLoaded
                  ...
                  : this.el.sceneEl.addEventListener(
                      "loaded",
                      this.initShape.bind(this)
                    );
              },
              initShape: function () {
                this.bodyEl = this.el;
                for (
                  var bodyType = this._findType(this.bodyEl), data = this.data;
                  !bodyType && this.bodyEl.parentNode != this.el.sceneEl;
                ...
                if (bodyType) {
                  ...
                  switch (
                    ...
                    data.hasOwnProperty("orientation") &&
                      (orientation = new CANNON.Quaternion()).copy(
                        data.orientation
                      ),
                    data.shape)
                  ) {
                    ...
                    case "cylinder":
                      ...
                      quat
                        .setFromEuler(90 * THREE.Math.DEG2RAD, 0, 0, "XYZ")
                        .normalize(),
                        orientation.mult(quat, orientation);
                      break;
                    default:
                      return void console.warn(
                        data.shape + " shape not supported"
                      );
                  }
                  this.bodyEl.body
                    ? this.bodyEl.components[bodyType].addShape(
                        shape,
                        offset,
                        orientation
                      )
              ...
              _findType: function (el) {
                return el.hasAttribute("body")
                  ? "body"
                  : el.hasAttribute("dynamic-body")
                  ? "dynamic-body"
                  : el.hasAttribute("static-body")
                  ? "static-body"
                  : null;
              },
              remove: function () {
                this.bodyEl.parentNode &&
                  console.warn(
                    "removing shape component not currently supported"
                  );
              },
            };
          ...
          module.exports = AFRAME.registerComponent("spring", {
            ...
            updateSpring: function (oldData) {
              if (this.spring) {
                ...
                console.warn(
                  "Spring: Component attempted to change spring before its created. No changes made."
                );
            },
            ...
            step: function (t, dt) {
              return this.spring && this.isActive
      ...
      20: [
        function (require, module, exports) {
          ...
          "undefined" != typeof window &&
            ((window.AmmoModule = window.Ammo), (window.Ammo = null));
          function AmmoDriver() {
          ...
          (AmmoDriver.prototype = new Driver()),
                ...
                AmmoModule().then((result) => {
                  (Ammo = result),
                    ...
                    this.physicsWorld.setGravity(
                      new Ammo.btVector3(
                        0,
                        worldConfig.hasOwnProperty("gravity")
                          ? worldConfig.gravity
                          : -9.8,
                        0
                      )
            ...
            (AmmoDriver.prototype.updateBody = function (body) {
              this.els.has(Ammo.getPointer(body)) &&
            ...
            (AmmoDriver.prototype.step = function (deltaTime) {
              ...
              for (let i = 0; i < numManifolds; i++) {
                const persistentManifold =
                    this.dispatcher.getManifoldByIndexInternal(i),
                ...
                for (let j = 0; j < numContacts; j++) {
                  if (
                    persistentManifold.getContactPoint(j).getDistance() <=
                    this.epsilon
                  ) {
                    collided = !0;
                    break;
                ...
                collided &&
                  ...
                  -1 === this.collisions.get(body0ptr).indexOf(body1ptr) &&
                    ...
                    -1 !== this.eventListeners.indexOf(body0ptr) &&
                      this.els
                        .get(body0ptr)
                        .emit("collidestart", {
                          targetEl: this.els.get(body1ptr),
                        }),
                    -1 !== this.eventListeners.indexOf(body1ptr) &&
                      this.els
                        .get(body1ptr)
                        .emit("collidestart", {
                          targetEl: this.els.get(body0ptr),
                        })),
                  this.currentCollisions.has(body0ptr) ||
            ...
            (AmmoDriver.prototype.removeEventListener = function (body) {
              ...
              -1 !== this.eventListeners.indexOf(ptr) &&
            ...
            (AmmoDriver.prototype.getDebugDrawer = function (scene, options) {
              return (
                this.debugDrawer ||
                  (((options = options || {}).debugDrawMode =
                    options.debugDrawMode || this.debugDrawMode),
      ...
      23: [
        function (require, module, exports) {
          ...
          (LocalDriver.prototype = new Driver()),
            ...
            (LocalDriver.prototype.applyBodyMethod = function (
              body,
              methodName,
              args
            ) {
            ...
            (LocalDriver.prototype.addMaterial = function (materialConfig) {
              (this.materials[materialConfig.name] = new CANNON.Material(
                materialConfig
              )),
                (this.materials[materialConfig.name].name = materialConfig.name);
            }),
            (LocalDriver.prototype.addContactMaterial = function (
              matName1,
              matName2,
            ...
            (LocalDriver.prototype.addConstraint = function (constraint) {
              constraint.type ||
                (constraint instanceof CANNON.LockConstraint
                  ...
                  : constraint instanceof CANNON.PointToPointConstraint &&
      ...
      26: [
        function (require, module, exports) {
          ...
          (WorkerDriver.prototype = new Driver()),
            ...
            (WorkerDriver.prototype.step = function () {
              if (this.interpolate) {
                for (
                  ...
                  prevFrame &&
                  nextFrame &&
                  timestamp - prevFrame.timestamp > this.frameDelay;
                ...
                if (prevFrame && nextFrame) {
                  ...
                  for (var id in ((mix =
                    (mix - (1 - 1 / this.interpBufferSize)) *
                    this.interpBufferSize),
                  prevFrame.bodies))
            ...
            (WorkerDriver.prototype.applyBodyMethod = function (
              body,
              methodName,
              args
            ) {
            ...
            (WorkerDriver.prototype.addContactMaterial = function (
              matName1,
              matName2,
              contactMaterialConfig
            ) {
              ...
              switch (data.type) {
                case Event.INIT:
                  (driver =
                    "cannon" === data.engine
                      ? new LocalDriver()
                      : new AmmoDriver()).init(data.worldConfig),
                    (stepSize = 1 / data.fps),
                ...
                case Event.ADD_CONSTRAINT:
                  var constraint = protocol.deserializeConstraint(
                    data.constraint,
                    bodies
                  );
                ...
                default:
                  throw new Error(
                    "[Worker] Unexpected event type: %s",
                    data.type
                  );
              }
            });
        ...
        function (require, module, exports) {
          ...
          module.exports = AFRAME.registerSystem("physics", {
            ...
            async init() {
              ...
              "ammo" !== data.driver
                ? (await this.driver.init({
                  ...
                  this.driver.addContactMaterial(
                    "defaultMaterial",
                    "defaultMaterial",
                    {
                      ...
                      frictionEquationRegularization:
                        data.frictionEquationRegularization,
                    }
                  ),
                  this.driver.addContactMaterial(
                    "staticMaterial",
              ...
              (this.debug = debug),
                "ammo" === this.data.driver &&
                  ...
                  (debug && !this.debugDrawer
                    ? ((this.debugDrawer = this.driver.getDebugDrawer(
                        this.el.object3D
                      )),
                      this.debugDrawer.enable())
                    : this.debugDrawer &&
                      (this.debugDrawer.disable(), (this.debugDrawer = null)));
            },
            ...
            removeComponent: function (component) {
              var callbacks = this.callbacks;
              component.beforeStep &&
                callbacks.beforeStep.splice(
                  callbacks.beforeStep.indexOf(component),
                  1
                ),
                component.step &&
                  callbacks.step.splice(callbacks.step.indexOf(component), 1),
                component.afterStep &&
                  callbacks.afterStep.splice(
                    callbacks.afterStep.indexOf(component),
                    1
                  );
            },
        ...
        function (require, module, exports) {
          ...
          function deserializeShape(message) {
            ...
            if (message.type === CANNON.Shape.types.BOX)
              ...
              (shape = new CANNON.Cylinder(
                message.radiusTop,
                message.radiusBottom,
                message.height,
                message.numSegments
              ))._type = CANNON.Shape.types.CYLINDER;
            }
            return shape;
          }
          ...
          (module.exports.assignID = function (prefix, object) {
            ...
            (module.exports.serializeBody = function (body) {
              return {
                ...
                shapeOrientations:
                  body.shapeOrientations.map(serializeQuaternion),
            ...
            (module.exports.deserializeBodyUpdate = function (message, body) {
              return (
                ...
                body.angularVelocity.set(
                  ...
                  message.angularVelocity[1],
                  message.angularVelocity[2]
                ),
                ...
                body.mass !== message.mass &&
                  ((body.mass = message.mass), body.updateMassProperties()),
                body
              );
            }),
            (module.exports.deserializeInterpBodyUpdate = function (
              message1,
              message2,
              body,
              mix
              ...
              var quaternion = mathUtils.slerp(
                message1.quaternion,
                message2.quaternion,
                mix
              );
              return (
                ...
                body.angularVelocity.set(
                  message1.angularVelocity[0] * weight1 +
                    message2.angularVelocity[0] * weight2,
                  message1.angularVelocity[1] * weight1 +
                    message2.angularVelocity[1] * weight2,
                  message1.angularVelocity[2] * weight1 +
                    message2.angularVelocity[2] * weight2
                ),
                ...
                body.mass !== message2.mass &&
                  ((body.mass = message2.mass), body.updateMassProperties()),
                body
              );
            }),
